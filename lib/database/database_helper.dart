...
Future<bool> insertarPerforacionConDetalles({
  ...
  try {
    await db.transaction((txn) async {
      // Insertar la perforación principal
      ...
      // Insertar cada detalle ligado a esa perforación
      for (var detalle in detalles) {
    ...
    print('Error al insertar perforación con detalles: $e');
    return false;
  }
}
...
Future<List<Map<String, dynamic>>> obtenerPerforacionMedicionesEstructura(int id) async {
  try {
    ...
    for (var perforacion in perforaciones) {
      ...
      // Obtener los detalles asociados a la perforación
      ...
      // Agregar los detalles como una clave dentro del mapa de la perforación
    ...
    print('Error al obtener estructura de perforación: $e');
    return [];
  }
}
...
Future<bool> eliminarPerforacionPorId(int perforacionId) async {
  try {
    ...
    print('Perforación eliminada: $deleted');
    return deleted > 0;
  } catch (e) {
    print('Error al eliminar perforación: $e');
    return false;
  }
}
