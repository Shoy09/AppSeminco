class ApiConfig {
  static const String baseUrl =
      'https://backend-seminco.onrender.com/api';
  ...
  static const String operacionHorizontalEndpoint = '/operacion/horizontal';
    static const String operacionHorizontalEndpointActualiza = '/operacion/update-horizontal';
  static const String operacionSostenimientoEndpoint = '/operacion/sostenimiento';
      static const String operacionSostenimientoEndpointActualiza = '/operacion/update-sostenimiento';
