...
// import 'package:app_seminco/mina%201/screens/Mediciones/listar_mediciones.dart';
...
//       exploraciones = await DatabaseHelper_Mina1().getExploraciones();
...
//     final success = await DatabaseHelper_Mina1().insertarPerforacionConDetalles(
//       db: db,
