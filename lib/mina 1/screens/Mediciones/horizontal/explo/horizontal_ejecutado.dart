...
Future<void> _cargarExploraciones() async {
                ...
                children: exploracionesPorEmpresa.entries.map((entry) {
                  ...
                  return Card(
                    ...
                    child: ExpansionTile(
                      title: Text(
                        empresa,
                        // Mostramos el nombre de la empresa como título
                              ...
                              SingleChildScrollView(
                                ...
                                child: Table(
                                  ...
                                  columnWidths: const {
                                    ...
                                    12: FlexColumnWidth(0.8), // Columna Activo
                                    13: FlexColumnWidth(
                                        1.0), // Columna Remanente
                                  },
                                  children: [
                                    ...
                                    for (int i = 0;
                                      ...
                                      TableRow(children: [
                                        ...
                                        tableCellEditable(
                                          ...
                                          _exploraciones.indexOf(
                                              exploracionesEmpresa[
                                                  i]), // Encuentra el índice en _exploraciones
                                          'avance_programado',
                                          exploracionesEmpresa[i]
                                              ['avance_programado'],
                                          // Los campos se deshabilitan si está activo
                                        ...
                                        tableCellEditable(
                                          ...
                                          // Los campos se deshabilitan si está activo O si está remanente
                                          !(exploracionesEmpresa[i]['activo'] ==
                                                  1 ||
                                              exploracionesEmpresa[i]
                                                      ['remanente'] ==
                                        ...
                                        TableCell(
                                          ...
                                          child: Checkbox(
                                            value: exploracionesEmpresa[i]
                                                    ['activo'] ==
                                                1,
                                            // Deshabilitar el checkbox Activo si Remanente está marcado
  ...
  child: Checkbox(
    ...
    // Deshabilitar el checkbox Remanente si Activo está marcado
...
// Modificar tableCellEditable para aceptar parámetro de habilitación
...
Future<void> insertarYActualizarMedicionesHorizontal() async {
  ...
  try {
    ...
    if (idsParaActualizar.isNotEmpty) {
      ...
      if (!mounted) return; // <-- Verificación importante
      ScaffoldMessenger.of(context).showSnackBar(
