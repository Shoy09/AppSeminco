...
class _EstadoRegistroPerforacionScreenState
  ...
  void obtenerEstadosBD() async {
    estadosBD = await DatabaseHelper_Mina1().getEstadosBD(
...
Widget cellText(String text, {bool isSmallScreen = false}) {
  ...
  void showRegisterOperationDialog(
    ...
    if (esCambioTurno && codigoOperativos.isNotEmpty) {
      ...
      DatabaseHelper_Mina1().updateHoraFinal(lastId, horaFinalTurno);
    }
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (selectedCodigo != null && selectedTime != null) {
                            ...
                            int result = await DatabaseHelper_Mina1().createEstado(
                              operacionId,
                              newNumber,
                              selectedState,
                              selectedCodigo!,
