...
import 'registro_perforacion_sreen_no_operativas.dart';

class ListaPerforacionCargioScreen extends StatefulWidget {
final String tipoOperacion;
final String? rolUsuario; 
  const ListaPerforacionCargioScreen({Key? key, required this.tipoOperacion, this.rolUsuario })
      : super(key: key);
...
class _ListaPerforacionScreenState extends State<ListaPerforacionCargioScreen> {
