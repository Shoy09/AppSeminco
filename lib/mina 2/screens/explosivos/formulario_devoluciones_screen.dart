...
class _FormularioDevolucionesScreenState
  ...
  Future<void> generatePdf() async {
    ...
    List<Map<String, dynamic>> datos =
        await DatabaseHelper_Mina2().obtenerEstructuraCompleta(widget.exploracionId);
...
//-------------------------------------------------------------------------------------------------------
  ...
  Future<bool> _actualizarDevoluciones() async {
    ...
    int result = await DatabaseHelper_Mina2()
  ...
  Future<void> _actualizarTiempos() async {
    ...
    int filasActualizadas =
        await DatabaseHelper_Mina2().actualizarTiemposDevoluciones(
      _DevolucionesId!,
      ms,
      lp,
    );
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // 🔹 Llamar directamente a la función en DatabaseHelper_Mina2
                await DatabaseHelper_Mina2().cerrarRegistro(widget.exploracionId);
  ...
  Future<bool> _guardarFormulario() async {
    ...
    List<Map<String, dynamic>> detallesDespacho =
        await DatabaseHelper_Mina2().getDetalleDespachoByDespachoId(_despachoId!);
