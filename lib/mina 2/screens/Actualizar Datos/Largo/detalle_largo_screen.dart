...
Future<void> _exportSelectedItems() async {
  ...
  for (var id in selectedItems) {
    ...
    // 4. Procesar estados con sus perforaciones
    final estadosLimpios = <Map<String, dynamic>>[];
    
    for (final estado in estados) {
      // Obtener perforaciones para este estado
      ...
      estadosLimpios.add({
        ...
        "perforaciones": perforacionesLimpias  // Perforaciones anidadas bajo su estado
      });
    }
    ...
    jsonDataList.add({
      ...
      "estados": estadosLimpios,  // Ahora incluye perforaciones anidadas
